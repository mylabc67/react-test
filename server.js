...
/**
 * GET /api/characters
 * Return 2 random characters of the same gender that not been voted yet
 */
...
/**
 * Get /api/characters/tops
 * Return 100 highest ranked characters. Filter by gender, race and bloodline
 */
app.get('/api/characters/tops', function(req, res, next) {
...
app.post('/api/characters', function(req, res, next) {
	...
	async.waterfall({
        ...
        function(charaterId) {
            var characterInfoUrl = 'https://api.eveonline.com/eve/CharacterInfo.xml.aspx?characterID=' + charaterId;
